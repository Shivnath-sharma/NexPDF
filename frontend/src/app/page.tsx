...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center w-full">
      {/* Hero Section */}
      <section className="w-full relative overflow-hidden py-16 lg:py-32 flex flex-col items-center justify-center text-center px-4">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight max-w-4xl mb-6">
        ...
        <p className="text-base sm:text-xl md:text-2xl text-muted-foreground max-w-2xl mb-10">
